    ...
    render() {
        return (
            <Stack.Navigator initialRouteName="Past Appointments">
                <Stack.Screen name="Past Appointments" component={PastAppointmentsScreen} />
                <Stack.Screen name="Appointment Details" component={AppointmentDetailsScreen}/>
                <Stack.Screen name="Appointment Summary" component={AppointmentSummaryScreen}/>
                <Stack.Screen name="Book an Appointment" component={ScheduleAppointmentScreen} />
            </Stack.Navigator>
        );
    }
}
