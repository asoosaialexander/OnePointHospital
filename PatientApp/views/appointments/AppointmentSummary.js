...
const DATA = [
    {
        ...
        title: 'You can cancel the appointment before 30 minutes from the appointment time & get 100% refund',
    },
    {
    ...
    render() {
        ...
        return (
            <View>
                ...
                <Divider style={{ height: 6, marginTop: 5, marginBottom: 5 }}></Divider>
                <View style={{ padding: 10 }}>
                    <View style={{
                        flexDirection: "row",
                ...
                <View style={{ padding: 10 }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ marginRight: 5 }} style={{}}>
                            <Button type={this.state.toggle ? "solid" : "outline"}
                                title="Brad John"
                                onPress={() => {
                        ...
                        <View style={{ alignItems: "baseline" }}>
                            <Button type="clear" title="Change Patient" onPress={toggleOverlay} />
                        </View>
                    </View>
                </View>
                <Divider style={{ height: 6, marginTop: 5, marginBottom: 5 }}></Divider>
                ...
                <Overlay
                    isVisible={this.state.overlayToggle} onBackdropPress={toggleOverlay}>
                    <View style={{ flex: 1, maxHeight: 400, width: 300 }}>
                        ...
                        <Input
                            ...
                            onChangeText={value => this.setState({ name: value })}
                        />
                        <Text style={{ fontSize: 18, paddingLeft: 10, color: "grey" }}>Gender</Text>
                        <ButtonGroup
